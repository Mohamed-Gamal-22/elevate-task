...
export default function FirstGifts() {
  return <>
    <div className="parent flex flex-wrap justify-between my-6 container w-[80%] mx-auto">
        <div className="gift w-full md:w-1/2 xl:w-1/3 p-3 relative">
            <Image src={gift2} alt="gift1" className='w-full rounded-2xl'/>
            <div className="content absolute inset-0 flex flex-col justify-center items-end pe-10">
